...
=begin
  ...
  MODELS << {
    ...
    :file => File.join(DATA_DIR,"gui_models","DSSTox_Carcinogenic_Potency_DBS_Hamster.csv"),
    :type => "classification",
    :feature_generation_uri => File.join($algorithm[:uri],"fminer","bbrc"),
    :min_frequency => 2,
    :test_values => {
...
=end
  ...
  MODELS << {
    ...
    :file => File.join(DATA_DIR,"gui_models","DSSTox_Carcinogenic_Potency_DBS_Mutagenicity_no_duplicates.csv"),
    :type => "classification",
    :feature_generation_uri => File.join($algorithm[:uri],"fminer","bbrc"),
    :min_frequency => 15,
    :test_values => {
